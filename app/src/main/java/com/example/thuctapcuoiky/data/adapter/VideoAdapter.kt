...
import com.example.thuctapcuoiky.databinding.ListVideoBinding
        ...
        fun setVideoPath(url: String) {
            ...
            exoPlayer.addListener(object : Player.Listener {
                override fun onPlayerError(error: PlaybackException) {
                    ...
                    Toast.makeText(context, "Can't play this video"+error.message, Toast.LENGTH_SHORT).show()
                    Log.e(TAG,"kiem tra video "+error.message)
                }
